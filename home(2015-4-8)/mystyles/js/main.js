...
function ShowItem1(){
	...
	ShowObj('needset'); ShowObj('head1'); HideObj('head2'); HideObj('adset1');ShowObj('votehead'); 		//ÏÔÊ¾Í¼Æ¬¿â
}

function ShowItem2(){
	ShowObj('head2'); ShowObj('adset'); HideObj('head1'); HideObj('needset');
	ShowObj('head2'); ShowObj('adset1'); HideObj('voteset');HideObj('head1'); HideObj('needset');HideObj('votehead'); 		//ÏÔÊ¾Í¼Æ¬¿â
}
