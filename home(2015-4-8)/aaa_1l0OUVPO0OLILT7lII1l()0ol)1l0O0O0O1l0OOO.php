...
if($dopost=="regbase" && $step==1){
	...
	//注册代码
	 ...
	 //会员的默认金币
        ...
        //$inQuery = "INSERT INTO `#@__member` (`mtype` ,`userid` ,`pwd` ,`uname` ,`sphone`,`sphone2` ,`qym` ,`sex` ,`rank` ,`money` ,`email` ,`scores` ,`matt`, `spacesta` ,`face`,`safequestion`,`safeanswer` ,`jointime` ,`joinip` ,`logintime` ,`loginip`,`from`)VALUES ('$mtype','$userid','$pwd','$userid','$userid','$sphone2','$qym','$sex','10','$dfmoney','$email','$dfscores','0','$spaceSta','','$safequestion','$safeanswer','$jointime','$joinip','$logintime','$loginip','1'); ";
        $inQuery = "INSERT INTO `#@__member` (`mtype` ,`userid` ,`pwd`,`form`,`uname` ,`sphone`,`sphone2` ,`qym` ,`sex` ,`rank` ,`money` ,`email` ,`scores` ,`matt`, `spacesta` ,`face`,`safequestion`,`safeanswer` ,`jointime` ,`joinip` ,`logintime` ,`loginip`)VALUES ('$mtype','$userid','$pwd','1','$fullname','$userid','$sphone2','$qym','$sex','10','$dfmoney','$email','$dfscores','0','$spaceSta','','$safequestion','$safeanswer','$jointime','$joinip','$logintime','$loginip'); ";
	  // echo $dsql->ExecuteNoneQuery($inQuery);exit;
