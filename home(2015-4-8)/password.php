...
*/
    ...
    */
    ...
    $query1 = "UPDATE `#@__member` SET pwd='$pwd' where mid='".$cfg_ml->M_ID."' ";
	...
	//判断个人用户还是企业用户
	if($mtype == "个人"){
   	 	ShowMsg('您的密码更改成功，请牢记！','index.php',0,5000);
	}else
	{
		ShowMsg('您的密码更改成功，请牢记！','index_company.php',0,5000);
	}
    exit();
}

include(DEDEMEMBER."/mystyles/a_password.htm");