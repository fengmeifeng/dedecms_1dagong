...
if($keywords != '' || $tags != ''){$keywords = cn_substrR(HtmlReplace($tags,1),30);}
//---------------------------------------------------------------------------------
$row_y = $dsql->GetOne("Select `rank` From `#@__member` where mid='$cfg_ml->M_ID'");
if($row_y['rank'] != '20000'){$mid = $cfg_ml->M_ID;}
//---------------------------------------------------------------------------------
