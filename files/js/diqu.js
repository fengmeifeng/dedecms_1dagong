...
function ChangeSon()
{
    ...
    */
	...
	if(document.getElementById('hidden_diqushitext')){
		document.getElementById('hidden_diqushitext').value = vtext;
	}
	/*---添加---end--------------------------------------------*/
    var newobj = oj.options;
...
function selNextSon()
{
	...
	/*---添加---and--------------------------------------------*/
	var vtext = this.options[this.selectedIndex].text;
	if(document.getElementById('hidden_diqushengtext')){
		document.getElementById('hidden_diqushengtext').value = vtext;
	}
	/*---添加---end--------------------------------------------*/
    var newobj = oj.options;
    var selarr = eval('em_'+emname+'s');
