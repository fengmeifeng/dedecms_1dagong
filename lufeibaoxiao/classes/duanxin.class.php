...
class Duanxin {
		...
		private $url="http://61.191.26.181:8888/SmsPort.asmx/SendSms?Epid=1022&User_Name=shenbo&password=5b805590a1636888";		//短信发送地址
	...
	function fs(){
		$this->url.="&phone=".$this->phone."&content=".$this->content."【要工作网】";
