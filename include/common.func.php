...
function ShowMsg($msg, $gourl, $onlymsg=0, $limittime=0)
{
    ...
    $htmlhead .= "<base target='_self'/>\r\n<link href=\"/files/css/msg.css\" rel=\"stylesheet\" /></head>\r\n<body leftmargin='0' topmargin='0' bgcolor='#FFFFFF'>".(isset($GLOBALS['ucsynlogin']) ? $GLOBALS['ucsynlogin'] : '')."\r\n<center>\r\n<script>\r\n";
    $htmlfoot  = "</script>\r\n</center>\r\n</body>\r\n</html>\r\n";
    ...
    else
    {
      ...
      function JumpUrl(){
        ...
        $rmsg = $func;
        $rmsg .= "document.write(\"<div class='panel panel-important'>";
        $rmsg .= "<div class='panel-heading'><h2>壹打工网</h2></div>\");\r\n";
        $rmsg .= "document.write(\"<div class='panel-body'>\");\r\n";
        ...
        if($onlymsg==0)
        {
            ...
            {
                $rmsg .= "<br /><a href='{$gourl}'>正在为您转接页面，您也可以点击这里...</a>";
                $rmsg .= "<br/></div>\");\r\n";
