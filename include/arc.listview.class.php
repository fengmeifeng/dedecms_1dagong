...
class ListView
{
    ...
    function __construct($typeid, $uppage=1)
    {
        ...
        if(!$this->IsError)
        {
            ...
            $this->Fields['title'] = preg_replace("/[<>]/", "", $this->TypeLink->GetPositionLink(false));//====可乐修改,list的title更改
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($totalpage<=1 && $this->TotalResult>0)
        {
            ...
            //return "<li class=\"disabled\">共 <strong>1</strong>页<strong>".$this->TotalResult."</strong>条记录</li>\r\n";
            return "<li class=\"disabled\"><a href=\"\">共 1 页/".$this->TotalResult." 条记录</a></li>\r\n";
        }
        if($this->TotalResult == 0)
        {
            //return "<li class=\"disabled\">共 <strong>0</strong>页<strong>".$this->TotalResult."</strong>条记录</li>\r\n";
            //return "<li class=\"disabled\">共 0 页/".$this->TotalResult." 条记录</li>\r\n";
			return "<li class=\"disabled\">暂无相关信息</li>\r\n";
        }
        $purl = $this->GetCurUrl();
        $maininfo = "<li class=\"disabled\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</li>\r\n";
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>&laquo;</a></li>\r\n";
        }
        else
        {
            $indexpage="<li class=\"disabled\"><a href=\"javascript:void(0);\">&laquo;</a></li>\r\n";
        }
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            ...
            $endpage="<li><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>&raquo;</a></li>\r\n";
        }
        else
        {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->TotalResult == 0)
        {
            //return "<li class=\"disabled\"><a href=\"\">共 0 页/".$this->TotalResult." 条记录</a></li>\r\n";
			return "<li class=\"disabled\"><a href=\"\">暂无相关信息</a></li>\r\n";
        }
        //$maininfo = "<li class=\"disabled\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</li>\r\n";
		$maininfo = "<li class=\"disabled\">共 <strong>{$totalpage}</strong>页<strong>".$this->TotalResult."</strong>条</li>\r\n";
        ...
        if($this->PageNo != 1)
        {
            ...
            $indexpage="<li><a href='".$purl."PageNo=1'>&laquo;</a></li>\r\n";
        }
        else
        {
            $indexpage="<li><a>&laquo;</a></li>\r\n";
        }
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<li><a href='".$purl."PageNo=$nextpagenum'>下一页</a></li>\r\n";
            $endpage="<li><a href='".$purl."PageNo=$totalpage'>&raquo;</a></li>\r\n";
        }
        else
        {
            $endpage="<li><a>&raquo;</a></li>\r\n";
        }
