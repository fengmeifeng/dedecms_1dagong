...
if($dopost=='save'){
	...
	*/	
		...
		//-----------spacesta='2'---------------------------------------------------------------------------
		$query = "UPDATE `#@__member` set qym='".$company."',uname='".$linkman."',sphone='".$sphone."',sphone2='".$mobile."',sex='".$sex."', shengfenid='".$shengfenid."',verify='1',xiaoshou='".$xiaoshou."',nativeplace='".$nativeplace."' WHERE mid='{$cfg_ml->M_ID}'";
		//echo $query;exit;
