		...
		if(!empty($_POST)){
			...
			if($id!=1){
				...
				if(empty($data)){
					...
					$usql="UPDATE `bingbing_hjdata` SET `sex` =  '".$sex."',`fullname` =  '".$fullname."',`syear` =  '".$syear."' where sphone='".$phone."'";
			...
			$querys = "UPDATE `{$membermodel->table}` set sex='".$sex."',uname='".$fullname."',mobile='".$phone."',syear='".$syear."',fullname='".$fullname."',qym='".$qym."',nativeplace='".$nativeplace."' WHERE mid='{$cfg_ml->M_ID}'";
			//echo $query."<br>";echo $querys;exit;
