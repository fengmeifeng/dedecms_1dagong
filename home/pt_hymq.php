...
if(empty($dopost))
{
    ...
    include(DEDEMEMBER."/mystyles/pt_hymq.htm");
    exit();
}
/*------------------------------
...
'$color','$writer','$source','$litpic','$pubdate','$senddate','$mid','$description','$keywords','$mtypesid'); ";
    ...
    //GetUpdateTest();
    //返回成功信息
	//ShowMsg("发布成功",'hymq.php?channelid=66',0,3000);
	$msg = "<div style=\"line-height:36px;height:36px\">发布成功</div>".GetUpdateTest();
   /*$msg = "
    　　请选择你的后续操作：
