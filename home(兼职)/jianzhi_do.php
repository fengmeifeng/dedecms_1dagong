...
else if($dopost=="edit")
{
    ...
    if($channelid==1)
    {
        $edit = 'jianzhi_edit.php?channelid='.$channelid;
    }
    else if($channelid==2)
    {
...
else if($dopost=="delArc")
{
    ...
    $ENV_GOBACK_URL = empty($_COOKIE['ENV_GOBACK_URL']) ? 'jianzhi.php?channelid=' : $_COOKIE['ENV_GOBACK_URL'];
    ...
    if($ENV_GOBACK_URL=='jianzhi.php?channelid=')
    {
