...
function ShowItem1()
{
	...
	ShowObj('needset'); ShowObj('head1'); HideObj('head2'); HideObj('adset1');ShowObj('votehead'); 		//显示图片库
}

function ShowItem2()
{
	ShowObj('head2'); ShowObj('adset'); HideObj('voteset');HideObj('head1'); HideObj('needset');HideObj('votehead'); 
	ShowObj('head2'); ShowObj('adset1'); HideObj('voteset');HideObj('head1'); HideObj('needset');HideObj('votehead'); 		//显示图片库
}
