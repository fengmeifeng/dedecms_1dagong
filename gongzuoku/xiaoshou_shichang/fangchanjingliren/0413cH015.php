...
<html lang="zh-cn">
	...
	<meta name="description" content="23232322323" />
	<title>ceshiceshi123发布的职位_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>ceshiceshi123发布的职位</h1>
                </div>
                <div class="h1_box">发布时间： 2015年04月13日</div>
                <div class="over">
                    <ul class="a_box">
                        <li ><span>工资：</span><strong>2000-3000</strong></font><span>元/月</span></li>
                        <li ><span>公司：</span><a href="/home/index.php?uid=19871&action=archives&channelid=81">测试测试测试测试123</a></li>
                        <li ><span>地区：</span>天津市 - 津南区</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>女</li>
                        <li ><span>学历要求：</span>初中以下</li>
                        <li ><span>招聘人数：</span>232323人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-22</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=997&job=19871&c=测试测试测试测试123"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=997&job=19871&c=测试测试测试测试123" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=997'>ceshiceshi123发布的职位</a></dt>
					<dd>23232322323...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=997">我想去</a></u></dd>
