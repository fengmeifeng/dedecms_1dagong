...
<html lang="zh-cn">
	...
	<meta name="description" content="23232 3" />
	<title>测试公司名称_壹打工网-让生活来找你</title>
	<!-- head_css-->
...
<div class="container">
	<div class="row">
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>安和时间段还是大红色</li>
                        <li ><span>地区：</span>天津市 - 宝坻区</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>女</li>
                        <li ><span>学历要求：</span>高中</li>
                        <li ><span>招聘人数：</span>323人人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-31</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1057&job=20087&c=安和时间段还是大红色"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        <span style="font-size:14px;">23232 3</span>
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1057&job=20087&c=安和时间段还是大红色" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=1057'>测试公司名称</a></dt>
					<dd>23232 3...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=1057">我想去</a></u></dd>
