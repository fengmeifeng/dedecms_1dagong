...
<html lang="zh-cn">
	...
	<meta name="description" content="职位描述藐米哦三居室的话说的好时机可能放大" />
	<title>测试发布的职位名称_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
...
<div class="container">
	<div class="row">
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>地区：</span>重庆市 - 永川区</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>初中</li>
                        <li ><span>招聘人数：</span>4人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-04-27</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1024&job=19870&c=测试测试测试测试"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        职位描述藐米哦三居室的话说的好时机可能放大
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1024&job=19870&c=测试测试测试测试" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
        ...
        <div class="col-md-3 col-sm-12 rcon">
			...
			<dl class="mr_10">
             <dt><a href='/plus/view.php?aid=1024'>测试发布的职位名称</a></dt>
					<dd>职位描述藐米哦三居室的话说的好时机可能放大...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=1024">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=999'>343434323</a></dt>
					<dd>343434343...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=999">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=747'>设备管理员</a></dt>
					<dd>工作内容：负责公司设备和电气的维护、维修
要求：1)高中以上学历，中级以...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=747">我想去</a></u></dd>
