...
<html lang="zh-cn">
	...
	<title>测试发布工作123_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=19864&action=archives&channelid=81">测收到收到收到收到</a></li>
                        <li ><span>地区：</span>安徽省 - 马鞍山市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>高中</li>
                        <li ><span>招聘人数：</span>5人人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-27</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=996&job=19864&c=测收到收到收到收到"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=996&job=19864&c=测收到收到收到收到" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
