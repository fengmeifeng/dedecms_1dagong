...
<html lang="zh-cn">
	...
	<title>熟练缝纫工_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=1&action=archives&channelid=81">旗牌王（合肥）制</a></li>
                ...
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=734&job=1&c=旗牌王（合肥）制"> 投递简历 </a>
...
4.普工: 10名
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=734&job=1&c=旗牌王（合肥）制" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
