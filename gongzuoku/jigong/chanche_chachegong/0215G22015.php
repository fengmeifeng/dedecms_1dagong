...
<html lang="zh-cn">
	...
	<title>叉车工/拖车工_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=1&action=archives&channelid=81">合肥市金润物流有</a></li>
                        <li ><span>地区：</span>安徽省 - 合肥市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>初中</li>
                        <li ><span>招聘人数：</span>30 人人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>1970-01-01</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=712&job=1&c=合肥市金润物流有"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、男性、身体健康、年龄18岁至50岁，一年以上工作经验，持有叉车证优先。
2、工作积极主动有责任心、服从各项工作安排。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=712&job=1&c=合肥市金润物流有" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
