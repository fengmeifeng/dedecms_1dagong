...
<html lang="zh-cn">
	...
	<title>普工/叉车工_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=1&action=archives&channelid=81">上海铱力物流有限</a></li>
                        <li ><span>地区：</span>安徽省 - 合肥市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>不限</li>
                        <li ><span>招聘人数：</span>5 人人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>1970-01-01</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=711&job=1&c=上海铱力物流有限"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <dl>
                        岗位：普工（叉车工） 人数不限
要求：男女不限，年龄18岁-35岁，初中以上学历，有仓库工作经验者优先。
叉车工需持有叉车上岗证，有2年以上高位叉车工作经验。
薪资待遇：基本工资+加班费 3000-3500左右
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=711&job=1&c=上海铱力物流有限" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
