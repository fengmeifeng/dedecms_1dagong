...
<html lang="zh-cn">
	...
	<title>55555555_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=19870&action=archives&channelid=81">测试测试测试测试</a></li>
                        <li ><span>地区：</span>重庆市 - 永川市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>不限</li>
                        <li ><span>学历要求：</span>中专</li>
                        <li ><span>招聘人数：</span>232321人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2015-05-20</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1031&job=19870&c=测试测试测试测试"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1031&job=19870&c=测试测试测试测试" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
