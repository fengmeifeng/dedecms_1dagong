        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>地区：</span>陕西省 - 宝鸡市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>不限</li>
                        <li ><span>学历要求：</span>初中</li>
                        <li ><span>招聘人数：</span>2 人人</li>
                        <!--<li ><span>报名人数：</span>12</li>-->
                        <li ><span>截止时间：</span>1970-01-01</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=737&job=1&c=admin"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <dl>
                        岗位职责：铸铁件的批灰、打磨、喷漆
任职要求：熟练掌握喷漆技能，会调漆。服从安排、有较强的责任心及团队意识。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=737&job=1&c=admin" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
