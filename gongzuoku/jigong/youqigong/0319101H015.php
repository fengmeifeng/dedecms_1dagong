...
<html lang="zh-cn">
	...
	<meta name="description" content="职位描述12121121233" />
	<title>销售代表一名3_壹打工网-让生活来找你</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span>安徽申博123</li>
                        <li ><span>地区：</span>湖北省 - 潜江市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>不限</li>
                        <li ><span>招聘人数：</span>15人</li>
                        <!--<li ><span>报名人数：</span></li>-->
                        <li ><span>截止时间：</span>2016-03-29</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=1017&job=20072&c=安徽申博123"> 投递简历 </a>
                ...
                <div class="d_led zhiwei-ms">
                    ...
                    <div class="write">
                    	...
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=1017&job=20072&c=安徽申博123" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
