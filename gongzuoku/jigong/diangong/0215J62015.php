        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=1&action=archives&channelid=81">合肥瑞洁物业管理</a></li>
                        <li ><span>地区：</span>江苏省 - 淮安市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>男</li>
                        <li ><span>学历要求：</span>大专</li>
                        <li ><span>招聘人数：</span>2 人人</li>
                        <!--<li ><span>报名人数：</span>23</li>-->
                        <li ><span>截止时间：</span>1970-01-01</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=746&job=1&c=合肥瑞洁物业管理"> 投递简历 </a>
...
(1)男性,1年以上相关工作经验;
(2)具有独立工作和解决问题的能力;
(3)有相关证书和物业公司工作经验者优先考虑。
(4)55周岁以内。
(5)试用期2400元/月,转正2700元/月。
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=746&job=1&c=合肥瑞洁物业管理" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
