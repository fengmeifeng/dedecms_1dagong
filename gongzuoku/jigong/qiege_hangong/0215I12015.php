...
<html lang="zh-cn">
	...
	<title>车工 普铣工 数铣工 钳工 氩弧焊工 剪板折弯工_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
...
<div class="container">
    <ol class="breadcrumb "><!--mt_20-->
		...
		<li>车工 普铣工 数铣工 钳工 氩弧焊工 剪板折弯工</li>
    </ol>
</div>
	...
	<div class="row">
    	<div class="col-md-9">
        	<div class="find mr_20">
                ...
                <div class="l_isj">
                	<h1>车工 普铣工 数铣工 钳工 氩弧焊工 剪板折弯工</h1>
                </div>
                <div class="h1_box">发布时间： 2015年02月15日</div>
                <div class="over">
                    <ul class="a_box">
                        <li ><span>工资：</span><strong>3000-5000</strong></font><span>元/月</span></li>
                        <li ><span>公司：</span><a href="/home/index.php?uid=1&action=archives&channelid=81">合肥开泰工贸有限</a></li>
                        <li ><span>地区：</span>安徽省 - 合肥市</li><!--{field:nativeplace function="Getsysenum(@me)"/}-->
                        <li ><span>性别要求：</span>不限</li>
                        <li ><span>学历要求：</span>初中</li>
                        <li ><span>招聘人数：</span>若干 人</li>
                        <!--<li ><span>报名人数：</span>12人</li>-->
                        <li ><span>截止时间：</span>2015-03-27</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=731&job=1&c=合肥开泰工贸有限"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        需要熟悉本工种，两年以上机械加工工作经验；工作认真负责，能够吃苦耐劳及服从工作安排；
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=731&job=1&c=合肥开泰工贸有限" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
...
<dt><a href='/plus/view.php?aid=733'>电焊工</a></dt>
					<dd>要求有二年以上手弧焊经验，男女不限，身体健康、责任心强，做事认真仔细，...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=733">我想去</a></u></dd>
<dt><a href='/plus/view.php?aid=732'>焊工</a></dt>
					<dd>1、	男、女不限，初中学历18-40岁之间，有焊接相关工作经验。
2、	愿意学徒也...</dd>
						<dd class="bb" style="height:20px;">
					<!-- <dd class='bb'><b>没有人</b>报名 --><u><a href="/plus/view.php?aid=732">我想去</a></u></dd>
