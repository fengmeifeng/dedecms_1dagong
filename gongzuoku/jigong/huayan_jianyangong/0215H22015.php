...
<html lang="zh-cn">
	...
	<title>生产线员工、品质检验员_壹打工网-工作让生活更精彩</title>
	<!-- head_css-->
        	...
        	<div class="find mr_20">
                ...
                <div class="over">
                    <ul class="a_box">
                        ...
                        <li ><span>公司：</span><a href="/home/index.php?uid=1&action=archives&channelid=81">安徽云森物联网科</a></li>
                        ...
                        <li ><span>截止时间：</span>2016-04-06</li>
                     </ul>
                </div>
                <div class="delivery text-center"><a class="btn btn-warning" href="/plus/toudi.php?aid=722&job=1&c=安徽云森物联网科"> 投递简历 </a>
                <a class="btn btn-default ml_30" href="/home/pt_gongzuo.php?channelid=81"> 我也要发布职位 </a></div>
                <div class="d_led zhiwei-ms">
                	<h4>职位描述</h4>
                    
                    <dl>
                        1、招聘要求：男女不限，中专以上学历，年龄：18岁至32岁；
2、岗位要求：工作认真细心踏实，动手能力强，服从管理；
                    </dl>
                    
                    <div class="write">
                    	<div class="pull-left resume">在壹打工网<a href="/home/pt_jianli.php">完善简历</a>，即有机会被企业和猎头推荐应聘</div>
                    	<div class="delivery pull-right"> <a class="btn btn-primary" href="/plus/toudi.php?aid=722&job=1&c=安徽云森物联网科" style="color:#fff;">投递简历</a></div>
                    </div>
                </div>
